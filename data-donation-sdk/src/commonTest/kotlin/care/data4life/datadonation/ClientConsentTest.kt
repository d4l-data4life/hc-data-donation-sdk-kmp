...
class ClientConsentTest {
    ...
    @Test
    fun `Given createUserConsent is called with a ConsentDocumentVersion and a Language it delegates its Parameter to the Usecase and returns a runnable Flow which emits a UserConsent`() = runWithContextBlockingTest(GlobalScope.coroutineContext) {
        // Given
    ...
    @Test
    fun `Given fetchConsentDocuments is called with a consentDocumentKey it delegates its Parameter to the ConsentDocumentController and returns a runnable Flow which emits a List of ConsentDocument`() = runWithContextBlockingTest(GlobalScope.coroutineContext) {
        // Given
    ...
    @Test
    fun `Given fetchUserConsents is called with a consentDocumentKey it delegates its Parameter to the UserConsentController and returns a runnable Flow which emits a List of UserConsent`() = runWithContextBlockingTest(GlobalScope.coroutineContext) {
        // Given
        val consentFlow = UserConsentControllerStub()
    ...
    @Test
    fun `Given fetchAllUserConsents is called it delegates its Parameter to the UserConsentController and returns a runnable Flow which emits a List of UserConsent`() = runWithContextBlockingTest(GlobalScope.coroutineContext) {
        // Given
        val consentFlow = UserConsentControllerStub()
        val consents = listOf(sampleUserConsent)
        val scope = CoroutineScope(testCoroutineContext)
    ...
    @Test
    fun `Given revokeUserConsent is called with a consentDocumentKey it delegates its Parameter to the UserConsentController and returns a runnable Flow which emits a UserConsent`() = runWithContextBlockingTest(GlobalScope.coroutineContext) {
        // Given
        val consentFlow = UserConsentControllerStub()
        val scope = CoroutineScope(testCoroutineContext)
