...
class Fhir3ResearchSubjectTest {
    @Test
    fun `It fulfils ResearchSubject`() {
        val researchSubject: Any = Fhir3ResearchSubjectWrapper(
    ...
    @Test
    fun `Given unwrap is called it returns the given Fhir3ResearchSubject`() {
        // Given
        val givenResearchSubject = Fhir3ResearchSubject(
            status = ResearchSubjectStatus.ACTIVE,
            study = Reference(),
            individual = Reference()
        )
        ...
        // When
        val actual = Fhir3ResearchSubjectWrapper(givenResearchSubject).unwrap()
    ...
    fun `It exposes the StudyIdentifierSystem if the Identifier is null`() {
        ...
        // When
        val actual = Fhir3ResearchSubjectWrapper(givenResearchSubject).studyIdentifierSystem
    ...
    fun `It exposes the StudyIdentifierValue if the Identifier is null`() {
        ...
        // When
        val actual = Fhir3ResearchSubjectWrapper(givenResearchSubject).studyIdentifierValue
    ...
    fun `It exposes the IndividualIdentifierSystem if the Identifier is null`() {
        ...
        // When
        val actual = Fhir3ResearchSubjectWrapper(givenResearchSubject).individualIdentifierSystem
    ...
    fun `It exposes null, if the wrapped ResearchSubject has no Period`() {
        ...
        // When
        val actual = Fhir3ResearchSubjectWrapper(givenResearchSubject).period
    ...
    fun `It exposes a wrapped Period, if the wrapped ResearchSubject has a Period`() {
        ...
        // When
        val actual: Any? = Fhir3ResearchSubjectWrapper(givenResearchSubject).period
    ...
    fun `Given copy is called with null as Period, returns a ResearchSubject which has no Period`() {
        ...
        // When
        val actual = Fhir3ResearchSubjectWrapper(givenResearchSubject).copy(
            period = null
        )
    ...
    fun `Given copy is called with a wrapped Period, returns a ResearchSubject which has the modified Period`() {
        ...
        val newValue = Fhir3PeriodWrapper(Fhir3Period())
