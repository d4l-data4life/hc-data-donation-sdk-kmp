...
internal class QuestionnaireResponseAnonymizerStub :
    ...
    MockContract.Stub {
    var whenAnonymize: ((questionnaireResponse: CompatibilityWrapperContract.QuestionnaireResponse<FhirVersion, FhirVersion, FhirVersion, FhirVersion>, ProgramType, QuestionnaireResponseBlurRule?) -> CompatibilityWrapperContract.QuestionnaireResponse<FhirVersion, FhirVersion, FhirVersion, FhirVersion>)? = null
