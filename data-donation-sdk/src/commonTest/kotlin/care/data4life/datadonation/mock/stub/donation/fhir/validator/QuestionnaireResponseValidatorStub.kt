...
internal class QuestionnaireResponseValidatorStub :
    ...
    MockContract.Stub {
    var whenIsAllowed: ((QuestionnaireResponse<out FhirVersion, out FhirVersion, out FhirVersion, out FhirVersion>, Map<AllowedReference, QuestionnaireResponseBlur?>) -> Boolean)? = null
