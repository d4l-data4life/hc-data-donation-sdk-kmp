...
internal object KeyDomainSerializer : KSerializer<PublicKeyServiceContract.KeyDomain> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor(
        "KeyDomain",
        PrimitiveKind.STRING
    )

    private val mapping = PublicKeyServiceContract.KeyDomain.values().associateBy { it.domain }

    override fun serialize(encoder: Encoder, value: PublicKeyServiceContract.KeyDomain) {
        encoder.encodeString(value.domain)
    }
