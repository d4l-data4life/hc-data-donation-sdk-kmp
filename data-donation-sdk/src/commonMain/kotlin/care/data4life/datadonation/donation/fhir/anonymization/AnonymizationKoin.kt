...
internal fun resolveAnonymizationKoinModule(): Module {
    return module {
        ...
        single<AnonymizationContract.QuestionnaireResponseAnonymizer> {
            QuestionnaireResponseAnonymizer(get(), get())
        }

        single<AnonymizationContract.ResearchSubjectAnonymizer> {
            ResearchSubjectAnonymizer(get())
        }
