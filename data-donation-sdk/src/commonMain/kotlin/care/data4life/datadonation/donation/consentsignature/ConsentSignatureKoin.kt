...
internal fun resolveConsentSignatureKoinModule(): Module {
    return module {
        single<ConsentSignatureContract.ApiService.ErrorHandler> {
            ConsentSignatureErrorHandler
        }

        single<ConsentSignatureContract.ApiService> {
            ConsentSignatureApiService(get(), get())
        }
